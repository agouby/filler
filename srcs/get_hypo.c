...
/*   Updated: 2017/03/15 20:27:24 by agouby           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_hypo(t_fill *fill, t_play *play, t_help *help)
{
	...
	while (play->pos_o.y != play->last_o.y || play->pos_o.x != play->last_o.x)
	{
		play->pos_m.x = play->first_m.x;
		play->pos_m.y = play->first_m.y;
		while (play->pos_m.y != play->last_m.y || play->pos_m.x != play->last_m.x)
		{
